...
export const Field=()=>{
    ...
    return(
     ...
     <div class="head"><h1 class="recent-Articles" style={{color:'purple'}}>STUDENTS FIELD WORK AND INTERNSHIP GUIDANCE</h1></div>
     ...
     <div className="ej">
        ...
        <select>
            <option value="">Nature of Guidance</option>
            <option value="0">Field Work</option>
            <option value="1">Internship</option>
            <option value="2">Student Projects</option>
