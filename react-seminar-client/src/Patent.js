...
export const Patent=()=>{
    ...
    return(
     ...
     <div class="head"><h1 class="recent-Articles" style={{color:'purple'}}>PATENT PUBLISHED GRANTED</h1></div>
     ...
     <div className="ej">
        ...
        <input type="text" placeholder="Title of the Patent"/>

        <label>Application No.</label>
        <input type="text" placeholder="Application No"/>

        <label>Date of Application</label>
        <input type="date" placeholder="Date of Application"/>

        <label>Date of Published/Granted</label>
        <input type="date" placeholder="Date of Published/Granted"/>
