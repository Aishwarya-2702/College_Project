...
export const Collaborate=()=>{
    ...
    <div class="head"><h1 class="recent-Articles" style={{color:'purple'}}>COLLABRATIVE ACTIVITIES WITH MoU SIGNED INDUSTRIES, INSTITUTIONS</h1></div>
    ...
    <div className="ej">
       ...
       <input type="text" placeholder="Name of MOU Signed Industry/Institution"/>

      

       <label>Time of the Activity</label>
       <input type="date" placeholder="Time of the Activity"/>

       <label>Duration From</label>
       <input type="date" placeholder="Duration From"/>

       <label>Duration To</label>
       <input type="date" placeholder="Duration To"/>
       ...
       <input type="date" placeholder="No of Benificiaries"/>
