...
export const Consult=()=>{
    ...
    <div class="head"><h1 class="recent-Articles" style={{color:'purple'}}>CONSULTANCY AND CORPORATE TRAINING DONE FOR REVENUE GENERATION</h1></div>
    ...
    <div className="ej">
       ...
       <input type="text" placeholder="Enter the Faculty Name"/>

       <label>Name of Consultancy Project/Corporate Training Program</label>
       < input type ="text"placeholder="Enter the Name of Project "/>

       <label>Consulting/Sponsoring Agency with Contact Details</label>
       <input type="Text" placeholder="Enter the Consulting Contact Details"/>
     
       <label>Date</label>
       <input type="date" placeholder="Enter the date"/>

       <label>Revenue Generated (in Lakhs)</label>
       <input type="Number" placeholder="Enter the Revenue"/>
       
       <label>Number of Trainees/Beneficiaries</label>
       <input type="Number" placeholder="Enter the Trainees Number"/>
